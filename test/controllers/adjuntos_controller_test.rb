...
class AdjuntosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adjunto" do
    assert_difference('Adjunto.count') do
      post adjuntos_url, params: { adjunto: { descripcion: @adjunto.descripcion, nombre: @adjunto.nombre, request_id: @adjunto.request_id } }
    end
  ...
  test "should update adjunto" do
    patch adjunto_url(@adjunto), params: { adjunto: { descripcion: @adjunto.descripcion, nombre: @adjunto.nombre, request_id: @adjunto.request_id } }
